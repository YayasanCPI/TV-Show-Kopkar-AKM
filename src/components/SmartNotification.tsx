...
export default function SmartNotification() {
  ...
  return (
    <div className="absolute inset-0 z-50 bg-slate-950 flex flex-col items-center justify-center p-12 overflow-hidden">
      ...
      <div className={`border-2 rounded-[3rem] p-16 max-w-7xl w-full text-center relative z-10 bg-slate-900/80 backdrop-blur-3xl shadow-2xl flex flex-col xl:flex-row items-center gap-16
