...
export default function FlyerSlide({ slide }: Props) {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center py-4">
      ...
      <div className="w-full h-full flex-1 flex items-center justify-center overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/40 backdrop-blur-xl shadow-2xl relative p-4 md:p-8 min-h-0">
