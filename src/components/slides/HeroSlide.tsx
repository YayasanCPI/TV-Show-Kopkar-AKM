...
export default function HeroSlide({ slide }: Props) {
 ...
 <div className="w-48 h-48 md:w-64 md:h-64 bg-white/10 text-cyan-400 rounded-full flex items-center justify-center shadow-[0_0_60px_rgba(59,130,246,0.3)] border border-white/20 mb-6 md:mb-8 relative z-10 overflow-hidden p-4 md:p-6">
