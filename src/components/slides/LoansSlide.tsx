...
export default function LoansSlide({ slide }: Props) {
 ...
 <div className="bg-slate-900/40 rounded-[4rem] p-24 w-full max-w-7xl mx-auto shadow-2xl flex flex-col md:flex-row items-center justify-between border border-white/10 relative overflow-hidden group">
 ...
 <div className="absolute inset-0 bg-blue-500 opacity-30 rounded-full"></div>
 ...
 <div key={index} className="bg-slate-800/60 rounded-3xl p-8 px-12 shadow-xl border border-white/10 hover:border-blue-500/50 hover:bg-slate-800/90 transition-all duration-300 flex items-center gap-6">
