    ...
    <div className="w-full h-full flex flex-col items-center justify-center">
      ...
      <div className="flex flex-row w-full max-w-7xl mx-auto gap-8 lg:gap-16 items-center flex-grow pt-4">
        ...
        <div className="flex-1 flex justify-center items-center relative h-full">
          <div className="w-[18rem] md:w-[22rem] h-[36rem] md:h-[44rem] bg-slate-900/80 backdrop-blur-xl rounded-[3rem] border-[4px] border-white/20 shadow-[0_0_60px_rgba(34,211,238,0.3)] relative overflow-hidden flex flex-col pt-10 md:pt-12 items-center bg-gradient-to-b from-slate-800/90 to-slate-950/90 ring-4 md:ring-8 ring-slate-950">
            ...
            <div className="w-full bg-black/80 flex-1 rounded-t-[2.5rem] p-6 md:p-8 flex flex-col gap-4 md:gap-6 shadow-[inset_0_20px_40px_rgba(0,0,0,0.5)] border-t border-white/10 backdrop-blur-md">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="bg-slate-900/40 backdrop-blur-xl p-10 md:p-16 rounded-[4rem] shadow-[0_0_60px_rgba(0,0,0,0.3)] flex flex-col items-center border border-white/10 relative overflow-hidden group">
