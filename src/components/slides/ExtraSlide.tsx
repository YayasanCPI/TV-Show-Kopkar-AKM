...
export default function ExtraSlide({ slide }: Props) {
 ...
 <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 via-blue-500/10 to-indigo-500/10 rounded-full pointer-events-none -z-10"></div>
 ...
 return (
 <div key={index} className="flex-1 bg-slate-900/40 border border-white/10 hover:border-white/20 rounded-[3.5rem] p-16 shadow-2xl flex flex-col items-center text-center transform hover:-translate-y-4 transition-all duration-500 group overflow-hidden relative">
