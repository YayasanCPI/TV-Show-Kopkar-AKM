  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-7xl mx-auto gap-12 pt-8">
        {/* Visi */}
        <div className="flex-1 bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-[3rem] p-16 text-white shadow-2xl flex flex-col items-center text-center relative overflow-hidden group">
        ...
        {/* Misi */}
        <div className="flex-1 bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-[3rem] p-16 text-white shadow-2xl flex flex-col items-center relative overflow-hidden group">
