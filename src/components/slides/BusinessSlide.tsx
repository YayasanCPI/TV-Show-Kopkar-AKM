...
export default function BusinessSlide({ slide }: Props) {
 ...
 <div key={idx} className="bg-slate-900/40 border border-white/10 rounded-[2.5rem] p-10 shadow-2xl flex items-center gap-8 transform hover:scale-[1.02] hover:bg-slate-800/60 hover:border-blue-500/40 transition-all duration-300 group overflow-hidden relative">
