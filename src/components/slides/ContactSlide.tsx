...
export default function ContactSlide({ slide }: Props) {
 ...
 <div key={index} className="bg-slate-900/40 p-12 rounded-[3.5rem] border border-white/10 flex flex-col items-center text-center shadow-2xl relative overflow-hidden group hover:-translate-y-2 transition-all duration-300 hover:border-blue-500/40">
 ...
 <div key={idx} className="flex items-center gap-6 bg-slate-900/40 border border-white/10 shadow-xl px-12 py-6 rounded-full hover:bg-slate-800/60 transition-colors">
 ...
 <div className="mt-16 flex items-center justify-center gap-8 relative z-10 bg-slate-900/40 mx-auto px-16 py-8 rounded-full border border-white/10 shadow-2xl">
